...
void send_node02_udp(uint8_t *buf,char *data,uint8_t datalen,uint16_t port)
{
        uint8_t i=0;
        uint16_t ck;
       /* buf[ETH_DST_MAC]= 0x00;
        buf[ETH_DST_MAC+1]= 0x15;
        buf[ETH_DST_MAC+2]= 0xaf;
        buf[ETH_DST_MAC+3]= 0xcf;
        buf[ETH_DST_MAC+4]= 0xe6;
        buf[ETH_DST_MAC+5]= 0xc8;*/

        buf[ETH_DST_MAC]= 0x00;
        buf[ETH_DST_MAC+1]= 0x1B;
        buf[ETH_DST_MAC+2]= 0xFC;
        buf[ETH_DST_MAC+3]= 0x06;
        buf[ETH_DST_MAC+4]= 0x48;
        buf[ETH_DST_MAC+5]= 0x1D;
